...
class PlanParty {
    ...
    private static long funFactor(Vertex[] tree, int vertex, long[] weights, boolean[] parenting) {
    	...
    	if (weights[vertex] == Long.MAX_VALUE) 
        {
            ...
            {
            	//Determines fun factor of grand children and root
                ...
                //Determines fun factor of children
                int onlyChildren = 0;
                ...
                //Compares children and grand children + root to see which set results in the greatest fun factor
